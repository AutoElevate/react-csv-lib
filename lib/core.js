...
var arrays2csv = exports.arrays2csv = function arrays2csv(data, headers, separator, newLine) {
  return joiner(headers ? [headers].concat(_toConsumableArray(data)) : data, separator, newLine);
};

var jsons2csv = exports.jsons2csv = function jsons2csv(data, headers, separator, newLine) {
  return joiner(jsons2arrays(data, headers), separator, newLine);
};
...
var string2csv = exports.string2csv = function string2csv(data, headers, separator) {
  ...
  return headers ? '' + headers.join(separator) + newLine + data : data;
};

var toCSV = exports.toCSV = function toCSV(data, headers, separator, newLine) {
...
var buildURI = exports.buildURI = function buildURI(data, uFEFF, headers, separator, newLine) {
  var csv = toCSV(data, headers, separator, newLine);
